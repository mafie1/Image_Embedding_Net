...
class UNet_spoco_new(nn.Module):
    def __init__(self, in_channels, out_channels):

        super(UNet_spoco_new, self).__init__()
        ...
        self.up_5 = ConvBlockOut(32, out_channels)
...
def test_small():
    ...
    model = UNet_spoco_new(in_channels=3, out_channels=12)
    preds = model(x)
    print(preds.shape)
